...
This example pages through every scheduled meeting a user hosts, picks out the ones whose topic contains a given phrase (case-insensitive), and cancels them, emailing the host and alternative hosts about each cancellation. It runs as a dry run by default and only lists what it would cancel.
